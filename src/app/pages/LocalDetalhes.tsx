...
import ManeGuideDetalhesDoLocalWeb from "../../imports/ManeGuideDetalhesDoLocalWeb/ManeGuideDetalhesDoLocalWeb";
  ...
  useEffect(() => {
    const handleClick = (e: MouseEvent) => {
      ...
      if (text.includes("Explorar") && dataName === "Link") {
        ...
        e.preventDefault();
        navigate("/login");
      } else if (text.includes("Voltar") || dataName?.includes("Back")) {
        e.preventDefault();
        navigate("/explorar");
      }
    };
